...
##'   \code{data.frame}) with 7652 rows and 76 columns.
##' \itemize {
...
##'     }
##'     \item HT99: "double" variable with 10 unique values in the range [1.25, 8.5], 5856 NA values.
...
##'     \item HT11: "double" variable with 28 unique values in the range [0.25, 13.5], 6088 NA values.
